...
The 141 million addresses are a tiny 1gb self-extracting zip file(7zip ultra).

No API, no restrictions, no credit card, no cost, and internet once for download of us addresses  

Only need two inputs, your list and the 141 million us addresses (all have zipcode).
...
PROCESS
   ...
   allow my 'not' unsafe to download. It is safe to download. Let me know if you have trouble.
